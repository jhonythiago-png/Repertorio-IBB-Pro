...
async function fetchCifraClubContent(url) {
    ...
    for (const getProxyUrl of proxies) {
        try {
            ...
            // AllOrigins retorna em 'contents', outros proxies podem retornar direto
    ...
    if (isLocalFile) {
        msg += '\n\n⚠️ DETECTADO: Você está testando o arquivo localmente (file://). O navegador bloqueia acessos externos por segurança.\n\nSOLUÇÃO: Para essa função funcionar, você precisa rodar o site em um servidor (como o Live Server do VS Code) ou hospedar o site online.';
    } else {
        msg += '\n\nO site pode estar bloqueando o acesso. Tente copiar e colar a letra manualmente.';
    }
