...
window.addEventListener('DOMContentLoaded', () => {
    ...
    if (shareSetlistBtn) {
        shareSetlistBtn.onclick = () => {
            ...
            // Detecta o link atual e limpa o protocolo para evitar a prévia
            const currentUrl = (window.location.origin + window.location.pathname + `?team=${team}`).replace('https://', '').replace('http://', '');
