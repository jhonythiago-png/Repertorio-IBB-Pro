...
function updateKeyIndicatorFromSemitones() {
    ...
    if (casaAtual > 0) {
        // Com capo ativo: tom real = formaKey + capo (som que o público ouve)
        // A transposição manual muda as notas escritas mas não o tom exibido
        keyIndicator.textContent = SCALE[(fIdx + casaAtual) % 12];
    } else {
