...
document.getElementById('cronogramaNav').onclick = (e) => {
    ...
    const isAdm = isAuthenticated();
    if (document.getElementById('addEventBtn')) document.getElementById('addEventBtn').style.display = isAdm ? 'inline-block' : 'none';
    if (document.getElementById('generateDefaultMonthBtn')) document.getElementById('generateDefaultMonthBtn').style.display = isAdm ? 'inline-block' : 'none';
    if (document.getElementById('clearMonthBtn')) document.getElementById('clearMonthBtn').style.display = isAdm ? 'inline-block' : 'none';
