...
window.addEventListener('DOMContentLoaded', () => {
    ...
    if (shareSetlistBtn) {
        shareSetlistBtn.onclick = () => {
            ...
            // Técnica suprema: Ícones gerados via URL-Encoding para evitar qualquer erro de servidor/GitHub
            const iconChurch = decodeURIComponent('%E2%9B%AA');     // ⛪
            const iconTeam   = decodeURIComponent('%F0%9F%91%A5'); // 👥
            ...
            _setlistSongs.forEach((song, idx) => {
                ...
                if (song.vid_id) {
                    // Removendo https:// para evitar a prévia automática no topo do WhatsApp
