...
document.getElementById('cronogramaNav').onclick = (e) => {
    ...
    document.getElementById('addEventBtn').style.display = isAdm ? 'inline-block' : 'none';
    document.getElementById('generateDefaultMonthBtn').style.display = isAdm ? 'inline-block' : 'none';
    document.getElementById('clearMonthBtn').style.display = isAdm ? 'inline-block' : 'none';
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    window.generateDefaultMonth = async () => {
        ...
        try {
            ...
            if (error) throw error;
            alert("Cronograma padrão gerado!");
            loadCronograma();
        } catch (err) {
    ...
    if (closeEventModal) {
        closeEventModal.onclick = () => document.getElementById('addEventModal').style.display = 'none';
    }
